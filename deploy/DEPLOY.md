...
```
NODE_ENV=production
APP_URL=https://blog-2-production-72bc.up.railway.app
...
## Post-deploy
1. Verify SSL: https://blog-2-production-72bc.up.railway.app
2. Test health: https://blog-2-production-72bc.up.railway.app/stripe/health
